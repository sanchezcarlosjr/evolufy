...
`evolufy` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/evolufy
[issue tracker]: https://github.com/<USERNAME>/evolufy/issues
